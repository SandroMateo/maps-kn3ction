...
MapMaker.prototype.companyLocations = function(company) {
  var image = "../../public/images/goldblum.png"
  if(company.location !== undefined) {
    var latLng = new google.maps.LatLng(company.location.lat, company.location.lng);
